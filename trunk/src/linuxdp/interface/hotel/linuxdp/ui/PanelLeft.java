...
public class PanelLeft extends JPanel implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getSource() == buttonChart) {
			JOptionPane.showMessageDialog(this, "bạn cần năng cấp dịnh vụ");
		}
