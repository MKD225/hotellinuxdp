...
public class CheckOutController {
	public static CheckOutController billItemController = new CheckOutController();
	private List<CheckOutListener> checkInListeners = new ArrayList<CheckOutListener>();
	...
	private void notifyListeners(CheckOut CheckOut) {
		...
		for (CheckOutListener listener : checkInListeners) {
