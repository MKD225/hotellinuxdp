...
public class Panel_Customer extends JPanel implements ActionListener,
	...
	private JPanel getClientPanel() {
		...
		panel.add(new JLabel("UserName:"), "left");
		panel.add(new JLabel("Customer"));

		panel.add(new JLabel("Phone:"), "left");
		panel.add(new JLabel("(+80) 0906-548.715"));

		panel.add(new JLabel("BirthDay:"), "left");
		panel.add(new JLabel("03/13/1989"));

		panel.add(new JLabel("Address:"), "left");
		panel.add(new JLabel("Nam Dinh"));

		panel.add(new JLabel("Fax:"), "left");
		panel.add(new JLabel("(+80) 0906-548.715"));

		panel.add(new JLabel("Registration #:"), "left");
		panel.add(new JLabel("#4534-AAC-324"));

		panel.add(new JLabel("Website:"), "left");
		panel.add(new JLabel("test.com"));
		return panel;
